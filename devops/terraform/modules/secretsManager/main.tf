resource "aws_secretsmanager_secret" "this" {
  ...
  name = "${var.service_name}-${var.stage_name}-tf"
...
locals {
  secrets = merge(
    var.secrets,
    {
      ...
      sls_users_table_id = "${var.users_table_id}"
      sls_chat_table_id = "${var.chat_table_id}"
      next_sls_eth_private_blockchain_ip = "${var.private_blockchain_ip}"
    },
  )
}