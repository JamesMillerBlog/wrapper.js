...
const GlobalStyle = createGlobalStyle`
    ...
    *, *:before, *:after {
    ...
    :root {
        ...
        --amplify-font-family:'Ford Antenna', 'Helvetica Neue Light', 'Helvetica Neue', 'Helvetica', 'Arial', 'sans-serif';  
    ...
    @font-face {
        font-family: 'Ford Antenna';
        src: url('FordAntennaCondWGL-Reg.otf') format('otf');
        font-weight: 400;
        font-style: normal;
        font-display: swap;
    }
    @font-face {
        ...
        src: url('FordAntennaCondWGL-Light.otf') format('otf');
        font-weight: 100;
        font-style: normal;
        font-display: swap;
    }
    @font-face {
        ...
        src: url('FordAntennaCondWGL-Med.otf') format('otf');
        font-weight: 700;
        font-style: bold;
        font-display: swap;
    }
