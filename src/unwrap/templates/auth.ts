...
export class Template implements TemplateInterface {
  static templateName = "Auth";
  name = Template.templateName;
  secrets: CreateAuthSecrets | undefined;
  config: AuthConfiguration | undefined;
  ...
  createSecrets = (config: AuthConfiguration): CreateAuthSecrets => {
    const {
      stage,
      region,
      root_domain_name,
  ...
  requestConfiguration = async (): Promise<AuthConfiguration> => {
