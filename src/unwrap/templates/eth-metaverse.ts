...
export class Template implements TemplateInterface {
  static templateName = "Eth-Metaverse";
  name = Template.templateName;
  secrets: CreateEthMetaverseSecrets | undefined;
  config: EthMetaverseConfiguration | undefined;
  ...
  createSecrets = (
    config: EthMetaverseConfiguration
  ): CreateEthMetaverseSecrets => {
    const {
      stage,
      region,
  ...
  requestConfiguration = async (): Promise<EthMetaverseConfiguration> => {
