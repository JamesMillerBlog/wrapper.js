    ...
    constructor(secretsRequired) {
        ...
        this.requestConfiguration = () => __awaiter(this, void 0, void 0, function* () {
            ...
            const ready_player_me_prompt = {
                ...
                message: "Enter the readyplayer.me subdomain used for creating and retrieving 3D Avatars.",
            ...
            const { ready_player_me } = yield inquirer_1.default.prompt(ready_player_me_prompt);
            return {
                configuration_name,
                stage,
                region,
